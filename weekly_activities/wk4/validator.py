...
# If the Speed Involved Flag is not null, there is a greater likelihood of fatal injuries TOT_FATAL_CNT. Aka sum(CRASH_SPEED_INVLV_FLG)/ sum(TOT_FATAL_CNT) > 0
